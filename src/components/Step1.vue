<template>
  <div class="main-container">
    ...
    <div class="contacts-container">
      ...
      <form class="form-contacts">
        <div class="contacts">
          ...
          <input class="input-phone" type="phone" 
          id="phoneOrganizator"
    ...
    <div class="event-date-container">
      ...
      <button class="add-data-button"> + Добавить дату</button>
      </div>
    </div>
    <div class="event-info-container">
      <form class="form-event-info">
        <div class="event-info">
          ...
          <option v-for="raiting of getRaitings" v-bind:key="raiting.id">{{raiting.title}}</option>
          </select>
        </div>
        <div class="event-info">
    ...
    <div class="buttons-container">
      ...
      <button class="continue-button" @click=onSubmit>Далее</button>
    </div>
  </div>
</template>
